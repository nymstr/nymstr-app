...
mod tests {
    ...
    let (secret_key, public_key) = PgpKeyManager::generate_keypair_secure(user_id, &passphrase)?;
    ...
    println!("     ✅ Signature verified: valid={}, signer={}",
    ...
    println!("     ✅ Public key exported, length: {} chars", public_armored.len());
